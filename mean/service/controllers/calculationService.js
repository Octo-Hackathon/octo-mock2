var eqiDet = require('../models/eqiDetail')
...
module.exports.minimumVariables = function(deferred) {
	var varArray = {};
	eqiDet.aggregate([
        // { $match: {
...
module.exports.maximumVariables = function(deferred) {
...
module.exports.minimumEqi = function(deferred) {
	var varArray = {};
	eqiRes.aggregate([
        { $group: {
            _id: "$domain",
...
module.exports.maximumEqi = function(deferred) {
